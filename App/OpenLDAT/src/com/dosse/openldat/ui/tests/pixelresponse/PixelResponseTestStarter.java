...
import com.dosse.openldat.tests.pixelresponse.PixelResponseTimeTest;
 ...
 * @author dosse
 */
public abstract class PixelResponseTestStarter extends javax.swing.JFrame {
     ...
     */
    public PixelResponseTestStarter(Device d) {
        this.d = d;
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Pixel Response Time Test - Configuration");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        PixelResponseTimeTest test = new PixelResponseTimeTest(d, step, (float) th1, (float) th2) {
            ...
            public void onDone(Map results) {
                ...
                double[][] ms = new double[steps.length][steps.length];
                for (int y = 0; y < steps.length; y++) {
                    for (int x = 0; x < steps.length; x++) {
                        if (x == y) {
                            ...
                            try {
                                ms[y][x] = (double) results.get("t" + steps[x] + ">" + steps[y]);
                            } catch (Throwable t) {
                                ms[y][x] = Double.NaN;
                            }
                        }
                ...
                EventQueue.invokeLater(new Runnable() {
                    @Override
                    public void run() {
                        PixelResponseTestResults ui = new PixelResponseTestResults(steps, ms, method, flickeringDetected) {
                            @Override
                            public void onClose() {
                                PixelResponseTestStarter.this.onClose();
                            }
                        };
    ...
    public static void run(Device d, Runnable doneCallback) {
        ...
        PixelResponseTestStarter ui = new PixelResponseTestStarter(d) {
            @Override
            public void onClose() {
                doneCallback.run();
            }
